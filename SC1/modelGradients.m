...
%networks
function [gradients,loss,parameters_joint] = modelGradients(parameters,parameters2,dlX,dlZ,dlT,dlX0,dlZ0,dlT0,dlH0,S0IC,dlX0BC3,dlX0BC4,dlX0BC5,dlX0BC6,dlZ0BC3,dlZ0BC4,dlZ0BC5,dlZ0BC6,dlT0BC3,dlT0BC4,dlT0BC5,dlT0BC6,T,S)
...
dH_Hx=dlgradient(sum(Hx,'all'),dlX,'EnableHigherDerivatives',true);
dH_Hz=dlgradient(sum(Hz,'all'),dlZ,'EnableHigherDerivatives',true);
